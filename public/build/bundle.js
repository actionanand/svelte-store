...
var app = (function () {
    ...
    class Button extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { mode: 0 });
    ...
    /* src/Cart/CartItem.svelte generated by Svelte v3.46.2 */
    const file$4 = "src/Cart/CartItem.svelte";

    // (58:2) <Button mode="outline" on:click={displayDescription}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(58:2) <Button mode=\\\"outline\\\" on:click={displayDescription}>",
    		ctx
    	});
    ...
    // (61:2) <Button on:click={removeFromCart}>
    function create_default_slot$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(61:2) <Button on:click={removeFromCart}>",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$4, 62, 4, 1316);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(62:2) {#if showDescription}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 55, 2, 1058);
    			attr_dev(h2, "class", "svelte-1td7xux");
    			add_location(h2, file$4, 56, 2, 1077);
    			attr_dev(li, "class", "svelte-1td7xux");
    			add_location(li, file$4, 54, 0, 1051);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	function displayDescription() {
    		...
    		const unSub = products.subscribe(prod => {
    			$$invalidate(3, description = prod.find(p => p.id === id).description);
    		});
    ...
    /* src/Cart/Cart.svelte generated by Svelte v3.46.2 */
    const file$3 = "src/Cart/Cart.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 46, 6, 807);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*items*/ 1) cartitem_changes.id = /*item*/ ctx[3].id;
    			if (dirty & /*items*/ 1) cartitem_changes.title = /*item*/ ctx[3].title;
    			if (dirty & /*items*/ 1) cartitem_changes.price = /*item*/ ctx[3].price;
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = text("Timer : ");
    			t4 = text(/*$timer*/ ctx[1]);
    			add_location(h1, file$3, 39, 2, 555);
    			attr_dev(ul, "class", "svelte-1c2znv1");
    			add_location(ul, file$3, 40, 2, 571);
    			add_location(h3, file$3, 49, 2, 858);
    			attr_dev(section, "class", "svelte-1c2znv1");
    			add_location(section, file$3, 38, 0, 543);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/Products/Product.svelte generated by Svelte v3.46.2 */
    const file$2 = "src/Products/Product.svelte";

    // (56:4) <Button on:click={addToCart}>
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(56:4) <Button on:click={addToCart}>",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 50, 4, 762);
    			attr_dev(h2, "class", "svelte-9ht2za");
    			add_location(h2, file$2, 51, 4, 783);
    			attr_dev(p, "class", "svelte-9ht2za");
    			add_location(p, file$2, 52, 4, 804);
    			add_location(div0, file$2, 49, 2, 752);
    			add_location(div1, file$2, 54, 2, 836);
    			attr_dev(div2, "class", "product svelte-9ht2za");
    			add_location(div2, file$2, 48, 0, 728);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/Products/Products.svelte generated by Svelte v3.46.2 */
    const file$1 = "src/Products/Products.svelte";
    ...
    // (17:2) {#each $products as product (product.id)}
    function create_each_block(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(17:2) {#each $products as product (product.id)}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 15, 2, 230);
    			attr_dev(section, "class", "svelte-o8blwk");
    			add_location(section, file$1, 14, 0, 218);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (30:4) <Button on:click="{() => showCart = !showCart}">
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(30:4) <Button on:click=\\\"{() => showCart = !showCart}\\\">",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let if_block = /*showCart*/ ctx[1] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "capitalize-it svelte-a7sran");
    			add_location(h1, file, 26, 2, 471);
    			add_location(br, file, 27, 2, 514);
    			add_location(div0, file, 28, 2, 521);
    			attr_dev(div1, "class", "header-wrap svelte-a7sran");
    			add_location(div1, file, 25, 0, 443);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const click_handler = () => $$invalidate(1, showCart = !showCart);
    	...
    	return [appName, showCart, click_handler];
    }
